...
<body>
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="請輸入姓名" runat="server" ControlToValidate="name" ErrorMessage="請輸入姓名" ForeColor="Red" InitialValue="1234"></asp:RequiredFieldValidator>
        <br />
        ...
        <br />
        再次確認&nbsp;&nbsp;&nbsp;&nbsp; :<asp:TextBox ID="com2" runat="server"></asp:TextBox>
